 ...
 */
package org.openmrs.module.atomfeedfilters.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.AtomfeedfiltersController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class AtomfeedfiltersController {
